$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Marcella and Alex's Wedding",

            // Event start date
            start: new Date('June 6, 2026 10:00'),
            ...
            end: new Date('June 6, 2026 00:00'),
    ...
    $('#rsvp-form').on('submit', throttle(function (e) {
        ...
        const hashTimeFormat = hashTime.getUTCFullYear().toString() +
            (hashTime.getUTCMonth() + 1).toString().padStart(2, '0') +
            hashTime.getUTCDate().toString().padStart(2, '0') +
        ...
        $.post('https://script.google.com/macros/s/AKfycbyicIunTL3rjpKS2cSwkMFHnrxA5IKacZ5Henqb_2p8wHBmY8sl8XsqUNqAINVhWEw/exec', data)
            .done(function (data) {
                console.log(data);
